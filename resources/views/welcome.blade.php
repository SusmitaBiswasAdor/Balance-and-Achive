...
<div class="landing-page">
    ...
    <div class="container mx-auto px-4 py-16 text-center">
        ...
        <a href="{{ route('register') }}" class="px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition">Try for free</a>
    </div>
</div>
    </nav>
    <!-- Hero Section -->
    <section class="hero bg-green-100 py-16 text-center">
        <div class="container mx-auto px-4">
            ...
            <!--<a href="{{ route('register') }}" class="mt-20 px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition">Try for Free</a>-->
        </div>
    </section>
